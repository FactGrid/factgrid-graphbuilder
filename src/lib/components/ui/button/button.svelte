	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				// FactGrid: orange is a call-to-action color, never a filled background
				cta: "border-accent bg-transparent text-accent hover:bg-accent/10 active:bg-accent/20 focus-visible:border-accent focus-visible:ring-accent/20",
			},
			size: {
